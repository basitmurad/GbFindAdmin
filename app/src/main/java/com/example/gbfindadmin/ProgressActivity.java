...
import com.example.gbfindadmin.vendorMode.OrderActivity;
...
public class ProgressActivity extends AppCompatActivity {
    ...
    public ProgressAdapter progressAdapter; // OrderAdapter reference
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.activeRecycler11);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        orders = new ArrayList<>();
        progressAdapter = new ProgressAdapter(orders,ownerShop); // Initialize OrderAdapter
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    Toast.makeText(ProgressActivity.this, "Orders found for this shop.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ProgressActivity.this, "No orders found for this shop.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ProgressActivity.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
